    ...
    <section className="py-16 sm:py-24 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        {outro.takeaway && outro.takeaway.length > 0 && (
          <ScrollReveal>
            <div className="bg-[var(--course-surface)] p-5 mb-8 border-4 border-[var(--course-text)]/40" style={{ boxShadow: "4px 4px 0px 0px color-mix(in srgb, var(--course-text) 25%, transparent)" }}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {relatedCourses.map((course) => (
                  <Link
                    ...
                    className="group block overflow-hidden border-4 border-[var(--course-text)]/40 transition-all duration-200 hover:-translate-y-1"
                  >
