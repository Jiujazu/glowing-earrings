    ...
    <section className="px-4 pb-12 sm:pb-16">
      <div className="max-w-3xl mx-auto">
        <ScrollReveal delay={300}>
          <div
            className="p-5 sm:p-6 border-4 border-[var(--course-text)]/80"
            style={{
              backgroundColor:
                ...
                <li key={mod.id}>
                  ...
                  >
                    {mod.icon ? (
                      ...
                      <span
                        className="flex items-center justify-center w-7 h-7 text-[11px] font-black font-heading flex-shrink-0 border-2 border-[var(--course-text)]/60 text-[var(--course-text-muted)] group-hover:border-[var(--course-primary)] group-hover:text-[var(--course-primary)] group-hover:bg-[var(--course-primary)]/10 transition-colors"
                      >
                        {i + 1}
                      </span>
                    )}
