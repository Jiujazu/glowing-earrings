...
export default function ScrollToTop({ modules }: ScrollToTopProps) {
  ...
  const btnClass =
    "w-10 h-10 bg-[var(--course-surface)] border-2 border-[var(--course-text)]/20 text-[var(--course-text-muted)] hover:text-[var(--course-text)] hover:border-[var(--course-primary)] transition-all duration-100 flex items-center justify-center press-feedback";
